...
import { signUpWithEmail, signInWithGoogle, authClient } from '@/lib/auth-client'
    ...
    <main className="auth-page">
      <div className="auth-column">
        ...
        <div className="auth-card" style={{ width: '100%', maxWidth: '400px', margin: '0 auto', padding: '1.5rem', background: 'var(--card-bg, rgba(255,255,255,0.05))', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
          <h2 style={{ fontSize: '1.25rem', fontWeight: '600', marginBottom: '1rem', textAlign: 'center' }}>Create your account</h2>
          ...
          <form onSubmit={handleEmailSignUp} style={{ display: 'flex', flexDirection: 'column', gap: '0.875rem' }}>
            <div>
              <label style={{ display: 'block', fontSize: '0.85rem', marginBottom: '0.25rem', opacity: 0.8 }}>Full Name</label>
              <input
                type="text"
                required
                value={name}
          ...
          <p style={{ textAlign: 'center', marginTop: '1.25rem', fontSize: '0.875rem' }}>
            ...
            <a href="/sign-in" style={{ color: '#2563eb', fontWeight: '600', textDecoration: 'underline', textUnderlineOffset: '3px' }}>
              Sign in
            </a>
          </p>
        </div>
